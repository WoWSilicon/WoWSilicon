...
enum PatchService {
    ...
    static func applyGamePatch(for version: GameVersion) throws {
        ...
        try copyResource(named: "d3d9", extension: "dll", subdirectory: "Patching/winerosetta", to: gameURL.appendingPathComponent("d3d9.dll"))
        ...
        if version.supportsVanillaTweaks, let vanillaTweaksURL = resourceURL(named: "vanilla-tweaks", extension: "exe", subdirectory: "Patching/winerosetta") {
